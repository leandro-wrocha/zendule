                    ...
                    >
                        <div>
                            <div class="mb-5 sm:mb-8">
                                <h1 class="mb-2 font-semibold text-center text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                                    SIGN IN
                                </h1>
                                <p class="text-center text-gray-500 dark:text-gray-400">
                                    Choose one of the following to sign in to your account.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="grid grid-cols-1 grid-rows-2 gap-3 sm:gap-5">
                                ...
                                <button
                                    ...
                                    disabled
                                >
                                    <!-- Start SVG Outlook Logo -->
                                        @include('partials.svg.outlook-logo')
                                    <!-- End SVG Outlook Logo -->
