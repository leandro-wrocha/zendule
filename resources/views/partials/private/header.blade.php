        ...
        <div class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
            <!-- Hamburger Toggle BTN -->
                <button 
                    ...
                    class="z-99999 h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400"
            ...
            <button @click="copyToClipboard('Copy URL Calendar')" class="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-offset-gray-800">
                URL Calendar
            </button>

            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden" src="{{ asset('logo/logo.svg') }}" alt="Logo" />
                <img class="hidden dark:block" src="{{ asset('logo/logo-dark.svg') }}" alt="Logo" />
            </a>
                                ...
                                <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                                    <li>
                                        ...
                                        <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                            <img src="{{ asset('user/user-02.jpg') }}" alt="User" class="overflow-hidden rounded-full" />
                                            <span
                                    ...
                                    <li>
                                        ...
                                        href="#">
                                        <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                            <img src="{{ asset('user/user-03.jpg') }}" alt="User" class="overflow-hidden rounded-full" />
                                            <span
                                            class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                        </span>
                                    ...
                                    <li>
                                        ...
                                        href="#">
                                        <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                            <img src="{{ asset('user/user-04.jpg') }}" alt="User" class="overflow-hidden rounded-full" />
                                            <span
                                            class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                        </span>
                                    ...
                                    <li>
                                        ...
                                        href="#">
                                        <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                            <img src="{{ asset('user/user-05.jpg') }}" alt="User" class="overflow-hidden rounded-full" />
                                            <span
